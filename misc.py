...
class Misc():
    ...
    def elapsed_time(self, elapsed):
        try:
            ...
            self.log_exception(".elapsed_time() in menus.py:", e)
            sys.exit()
    ...
    def validate_id(self,options, shortcuts):
        ...
        try:
            ...
            self.log_exception(".validate_id() in menus.py:", e)
            sys.exit()
    ...
    def validate_choice(self, choices, text):
        ...
        try:
            ...
            self.log_exception(".validate_choice() in menus.py:", e)
            sys.exit()
    ...
    def confirm_choice(self):
        ...
        try:
            ...
            self.log_exception(".confirm_choice() in menus.py:", e)
            sys.exit()
    ...
    def clear_screen(self):
        ...
        try:
            ...
            self.log_exception(".clear_screen() in menus.py:", e)
            sys.exit()
    ...
    def close_terminal(self):
        ...
        try:
            ...
            self.log_exception(".close_terminal() in menus.py:", e)
            sys.exit()
    #---------------------------------------------------------------------------
    def create_directory(self, paths):
        ...
        try:
            ...
            self.log_exception(".create_directory() in menus.py:", e)
            sys.exit()
    ...
    def create_trackFile(self, file):
        ...
        try:
            ...
            self.log_exception(".create_trackFile() in menus.py:", e)
            sys.exit()
    ...
    def run_command(self, command, text, file, trackfile):
        ...
        try:
            ...
            self.log_exception("run_command() in menus.py:", e)
            sys.exit()
    ...
    ''')
            ...
            self.log_exception(".choose_chromosomes_to_index() in menus.py:", e)
            sys.exit()
    ...
    def create_new_fasta(self, chromosomes, shortcuts):
        try:
            ...
            self.log_exception(".create_new_fasta() in menus.py:", e)
            sys.exit()
    ...
    def create_new_gtf(self, chromosomes, filename, shortcuts):
        ...
        try:
            ...
            self.log_exception(".create_new_gtf() in menus.py:", e)
            sys.exit()
