...
''')
            ...
            cmd_env = "conda create -n sequencing -c bioconda bedtools bcftools biopython bwa-mem2 gatk4 picard=2.25.2-0 python=3.7.6 samtools=1.9 star pandas vcfpy scipy snpeff openpyxl"
