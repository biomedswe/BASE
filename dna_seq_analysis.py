...
class DnaSeqAnalysis():
    ...
    def index_genome_dna(self, misc, shortcuts):
        ...
        try:
            ...
            misc.log_to_file('Renaming chunk_* > chunk_*.bed succesfully completed - OK!')
        ...
        try:
            ...
            with open(shortcuts.alignedFiles_list, 'r') as list:
                for sample in list.read().splitlines():
                    cmd_validate = f"picard ValidateSamFile -I {shortcuts.aligned_output_dir}{options.tumor_id}/{sample} --MODE SUMMARY --IGNORE_WARNINGS true --TMP_DIR {shortcuts.aligned_output_dir}{options.tumor_id}/tmp_validate"
